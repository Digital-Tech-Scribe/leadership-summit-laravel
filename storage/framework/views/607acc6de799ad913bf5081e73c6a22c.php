<?php $__env->startSection('title', 'Speakers - Leadership Summit'); ?>
...
<section class="speakers-section py-5">
    <div class="container">
        ...
        <!-- Speakers Grid -->
        <?php if($speakers && $speakers->count() > 0): ?>
        <div class="speakers-grid">
            ...
            <article class="speaker-card">
                <div class="speaker-image">
                    ...
                    <img src="<?php echo e(asset('storage/' . $speaker->image)); ?>" alt="<?php echo e($speaker->name); ?>" class="img-fluid">
                    <?php else: ?>
                    <i class="fas fa-user" aria-hidden="true"></i>
                    <?php endif; ?>
                    <?php if($speaker->is_featured): ?>
                    <span class="speaker-badge">Featured</span>
                    <?php endif; ?>
                </div>
                <div class="speaker-content">
                    <h2 class="speaker-name"><?php echo e($speaker->name); ?></h2>
                    <p class="speaker-title"><?php echo e($speaker->title); ?></p>
                    <p class="speaker-company"><?php echo e($speaker->company); ?></p>
                    <p class="speaker-bio"><?php echo e(Str::limit($speaker->bio, 150)); ?></p>

                    <?php if($speaker->expertise): ?>
                    <div class="speaker-topics">
                        <?php $__currentLoopData = explode(',', $speaker->expertise); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $topic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <span class="topic-tag"><?php echo e(trim($topic)); ?></span>
                    ...
                    <div class="speaker-social">
                        ...
                        <a href="<?php echo e($speaker->linkedin); ?>" class="social-link" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn profile for <?php echo e($speaker->name); ?>">
                            <i class="fab fa-linkedin-in" aria-hidden="true"></i>
                        </a>
                        <?php endif; ?>
                        <?php if($speaker->twitter): ?>
                        <a href="<?php echo e($speaker->twitter); ?>" class="social-link" target="_blank" rel="noopener noreferrer" aria-label="Twitter profile for <?php echo e($speaker->name); ?>">
                            <i class="fab fa-twitter" aria-hidden="true"></i>
                        </a>
                        <?php endif; ?>
                        <?php if($speaker->website): ?>
                        <a href="<?php echo e($speaker->website); ?>" class="social-link" target="_blank" rel="noopener noreferrer" aria-label="Website for <?php echo e($speaker->name); ?>">
                            <i class="fas fa-globe" aria-hidden="true"></i>
                        </a>
                        <?php endif; ?>
                    </div>

                    <a href="<?php echo e(route('speakers.show', $speaker)); ?>" class="btn btn-primary">View Full Profile</a>
                </div>
            </article>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>

        <?php if(method_exists($speakers, 'links')): ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/Apple/Desktop/dev_folder/Dev_project/test.kiro2/leadership-summit-laravel/resources/views/speakers/index.blade.php ENDPATH**/ ?>