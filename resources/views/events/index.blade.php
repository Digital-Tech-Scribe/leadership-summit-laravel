...
@section('title', 'Events - Leadership Summit 2025')
@section('meta_description', 'Discover all events at the International Global Leadership Academy Summit 2025. Register for keynotes, workshops, and networking sessions.')
...
<section class="events-filters">
    <div class="container">
        <div class="filter-tabs">
            <a href="{{ route('events.index') }}" class="filter-tab {{ !request('date') && !request('status') ? 'active' : '' }}">
                All Events
            </a>
            <a href="{{ route('events.index', ['date' => 'today']) }}" class="filter-tab {{ request('date') == 'today' ? 'active' : '' }}">
                Today
            </a>
            <a href="{{ route('events.index', ['date' => 'week']) }}" class="filter-tab {{ request('date') == 'week' ? 'active' : '' }}">
                This Week
            </a>
            <a href="{{ route('events.index', ['date' => 'month']) }}" class="filter-tab {{ request('date') == 'month' ? 'active' : '' }}">
                This Month
            </a>
            <a href="{{ route('events.index', ['status' => 'featured']) }}" class="filter-tab {{ request('status') == 'featured' ? 'active' : '' }}">
                Featured
            </a>
            <a href="{{ route('events.calendar') }}" class="filter-tab">
            ...
            <article class="event-card {{ $event->featured ? 'featured-event' : '' }}">
                ...
                <div class="event-content">
                    ...
                    <h2 class="event-title">
                        <a href="{{ url('/events/' . $event->slug) }}" class="text-decoration-none">
                            {{ $event->title }}
                        </a>
                    </h2>
