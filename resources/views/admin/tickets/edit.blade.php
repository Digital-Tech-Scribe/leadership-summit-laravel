                    ...
                    <form method="POST" action="{{ route('admin.tickets.update', $ticket) }}">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror"
                                        value="{{ old('name', $ticket->name) }}" required placeholder="e.g., General Admission, VIP Pass">
                                    @error('name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror"
                                rows="3" placeholder="Describe what this ticket includes...">{{ old('description', $ticket->description) }}</textarea>
                            @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="price" id="price" class="form-control @error('price') is-invalid @enderror"
                                        value="{{ old('price', $ticket->price) }}" step="0.01" min="0" required placeholder="0.00">
                                    @error('price')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="quantity" id="quantity" class="form-control @error('quantity') is-invalid @enderror"
                                        value="{{ old('quantity', $ticket->quantity) }}" min="1" required placeholder="100">
                                    @error('quantity')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="max_per_order" id="max_per_order" class="form-control @error('max_per_order') is-invalid @enderror"
                                        value="{{ old('max_per_order', $ticket->max_per_order) }}" min="1" placeholder="10">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="datetime-local" name="sale_end" id="sale_end" class="form-control @error('sale_end') is-invalid @enderror"
                                        value="{{ old('sale_end', $ticket->sale_end ? $ticket->sale_end->format('Y-m-d\TH:i') : '') }}">
                                    <small class="form-text text-muted">Leave empty to sell until event starts. Tickets are available for purchase immediately.</small>
                                    @error('sale_end')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
